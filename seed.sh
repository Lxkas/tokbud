...
elasticdump --input=es_dump/time_record_mapping.json --output=http://localhost:9200/time_record --type=mapping
elasticdump --input=es_dump/time_record.json --output=http://localhost:9200/time_record --type=data
